...
namespace Andersc.AnyRun
{
    public sealed class API
    {
        ...
        private static int ssfSYSTEM = 37;              //System32 directory
        private static int ssfPROGRAMS = 2;             //Program Files
        private static int ssfDESKTOP = 0;
        private static int ssfDESKTOPDIRECTORY = 16;
        private static int ssfDRIVES = 17;
        private static int ssfPERSONAL = 5;             //My Documents folder
        private static int ssfCOMMONDESKTOPDIR = 25;
        private static int ssfWINDOWS = 36;             //Windows or Winnt directory

        public static string GetLinkPath(string lnkFile)
        {
            var shl = new Shell();
